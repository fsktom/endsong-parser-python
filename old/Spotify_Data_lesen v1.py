...
class output_Data:
        ...
        if array[0][0] == "title":
            for i in range(1, mainindex + 1):
                ...
                if percentages:
                    string += (
                        " ("
                        + str(round(array[i]["streams"] / percentages * 100, 5))
                        + "% of all)"
                    )
                print(string)
    ...
    def print_first_last(self, fl):
        ...
        print(
            ...
            + str(dt.datetime.utcfromtimestamp(fl[1]) + dt.timedelta(hours=+1))
        )
            ...
            if e[array[0][0]] == name:
                if array[0][0] == "title":
                    ...
                    if percentages:
                        string += (
                            " ("
                            + str(round(e["streams"] / percentages * 100, 5))
                            + "% of all)"
                        )
                    print(string)
                elif array[0][0] == "artist":
    ...
    def graph(self, ts):
        ...
        if ts[1] == "title":
            title = ts[2][2] + " from " + ts[2][0] + " from " + ts[2][1]
        elif ts[1] == "artist":
            title = ts[2][0]
        elif ts[1] == "album":
            title = ts[2][1] + " from " + ts[2][0]
        fig.autofmt_xdate()
...
paths = [
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_0.json",
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_1.json",
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_2.json",
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_3.json",
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_4.json",
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_5.json",
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_6.json",
    "c:\\Users\\Lulas\\Downloads\\MyData\\endsong_7.json",
]
